...
class SparkJob:
    ...
    def __init__(self):
        ...
        self.df_seats_ref = self.spark.createDataFrame(seats_data, ["province_name", "total_seats"])
    ...
    def run_job(self):
        ...
        stream_votes_silver = self.spark.readStream \
    ...
    def compute_seats_from_votes(self, df_batch, batch_id):
        """"""
        if df_batch.isEmpty():
            return
